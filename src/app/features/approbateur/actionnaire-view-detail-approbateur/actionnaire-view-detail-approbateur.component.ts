...
@Component({
  selector: 'app-actionnaire-view-detail-approbateur',
  standalone: true,
  imports: [CommonModule,RouterModule,MatPaginator],
  templateUrl: './actionnaire-view-detail-approbateur.component.html',
  styleUrl: './actionnaire-view-detail-approbateur.component.css'
})
export class ActionnaireViewDetailApprobateurComponent implements OnInit{
