...
@Component({
  selector: 'app-transaction-approbateur',
  standalone: true,
  ...
  templateUrl: './transaction-approbateur.component.html',
  styleUrl: './transaction-approbateur.component.css'
})
export class TransactionApprobateurComponent implements OnInit{
  ...
  openApprovedModal(transaction: Transaction) {
    this.selectedTransaction = transaction;
  }
  openRejectModal(transaction: Transaction) {
    this.selectedTransaction = transaction;
  }

  private updateChartData(filteredTransactions: Transaction[]) {
